                    ...
                    <div>
                        <form action="{{ route("sub-kriteria.store") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <label class="form-control w-full">
                                ...
                                <select name="kriteria_id" class="select select-bordered w-full bg-secondary-color text-primary-color-dark" required>
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="sub_kriteria" class="input input-bordered w-full bg-secondary-color text-primary-color-dark" value="{{ old("sub_kriteria") }}" required />
                                @error("sub_kriteria")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="number" min="0" step="0.01" name="bobot" class="input input-bordered w-full bg-secondary-color text-primary-color-dark" value="{{ old("bobot") }}" required />
                                @error("bobot")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                    ...
                    <div>
                        <form action="{{ route("sub-kriteria.update") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="kriteria_id" class="input input-bordered w-full bg-secondary-color text-primary-color-dark" required hidden />
                                <input type="text" name="kriteria_nama" class="input input-bordered w-full bg-primary-color text-secondary-color" required readonly />
                                @error("kriteria_id")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="sub_kriteria" class="input input-bordered w-full bg-secondary-color text-primary-color-dark" required />
                                @error("sub_kriteria")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="number" min="0" step="0.01" name="bobot" class="input input-bordered w-full bg-secondary-color text-primary-color-dark" required />
                                @error("bobot")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                ...
                @foreach ($kriteria as $kri)
                    <div class="mb-5">
                        <div class="border-b-solid mb-0 flex items-center justify-between rounded-t-2xl border-b-0 border-b-transparent p-6 pb-3">
                            <h6 class="font-semibold text-primary-color-dark">Tabel {{ $title }} <span class="font-bold text-primary-color">{{ $kri->kriteria }}</span></h6>
                        </div>
